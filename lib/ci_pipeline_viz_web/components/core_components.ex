defmodule CiPipelineVizWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(CiPipelineVizWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(CiPipelineVizWeb.Gettext, "errors", msg, opts)
    # end
